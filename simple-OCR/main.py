...
if method == "Upload file":
    ...
    if image_data:
        ...
        if st.button("Extract Text"):
            ...
            messages=[
                {"role": "system","content": "pretend you are rick sanchez, but you dont say Wubba Lubba Dub Dub, instead you will try to be the biggest asshole but still actively trying to answer me, if there are any answer, answer it straight away with the answer in bracelet"},
